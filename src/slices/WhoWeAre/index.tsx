    ...
    >
      <section>
        <div className="rc-container flex flex-col gap-10 overflow-hidden duration-300 md:flex-row">
          ...
          >
            <h6 className="font-bold text-[#DD841F]">WHO WE ARE</h6>
            ...
            <div className="flex items-center gap-3">
              <span className="grid h-14 w-14 place-items-center bg-primary">
                <Image
          ...
          >
            <div className="absolute -left-5 -top-5 bg-white p-1">
              <div className="w-fit bg-[#111827] p-5 text-center">
