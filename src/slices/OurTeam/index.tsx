      ...
      <section>
        <div className="rc-container flex flex-col gap-10 duration-300 md:flex-row">
          ...
          <div className="flex flex-col gap-5 md:w-1/2">
            <h6 className="font-bold text-primary">OUR TEAM</h6>
          ...
          <div className="flex flex-col gap-5">
            {slice.items.map((item, idx) => (
              <motion.div
                ...
                viewport={{ amount: 0.5 }}
                key={idx}
                className="relative ml-7 bg-[#111827] p-5"
              >
                <div className="absolute -left-7 top-1/2 h-14 w-14 -translate-y-1/2 bg-[#DD841F]">
                  {item.icon.url && <img src={item.icon.url} />}
                </div>
                <div className="ml-7">
                  <h6 className="text-md font-bold text-[#DD841F]">
                    {asText(item.heading)}
                  </h6>
